...
PERIODIC_SOURCES: tuple[SourceAssumption, ...] = (
    SourceAssumption(
        ...
        dfdt_status="representative CHIME-band summary value consistent with Pleunis et al. 2021's reported 'a few to tens of MHz/ms in the CHIME band' for sources where drift is apparent; not a specific quoted per-burst value, and must be replaced by burst-level baseband measurements for inference",
    ...
    SourceAssumption(
        ...
        dfdt_mhz_ms=-3.9,
        dfdt_frequency_mhz=1400.0,
        dfdt_status="representative L-band value within Hessels et al. 2019's reported -3 to -4 MHz/ms range at 1.1-1.7 GHz; cross-source scaling tests must apply f^2 normalization via the beam-geometry relation (Stage 4 / 5 equation)",
